...
void boilerplate_startscreen_draw(Canvas* canvas, BoilerplateStartscreenModel* model) {
    ...
    canvas_draw_str_aligned(canvas, 64, 10, AlignCenter, AlignTop, "NFC HID Reader");
    canvas_set_font(canvas, FontSecondary);
    canvas_draw_str_aligned(canvas, 64, 22, AlignCenter, AlignTop, "Connect to a computer");
    canvas_draw_str_aligned(canvas, 64, 32, AlignCenter, AlignTop, "and start reading NFC tags");
